#############################################################################################
# Checks the distribution of the speech segments for the Serial Speaker corpus.
#
...
#############################################################################################
# start logging
start.rec.log(text="PL_SpeechSegments")
...
#############################################################################################
# setup folders
in.folder <- file.path("in","speech_segments")
out.folder <- "out"
...
{	tlog(0,"-------------------------------")
	in.file <- file.path(in.folder,paste0(prefix,"_speech_segments.csv"))
